...
{
    public class AnotherSqlReaderMapper : AnotherISqlReaderMapper
    {
        private readonly SqlIconnectionFactory _connectionFactory;
        private readonly string _connectionString;

        public AnotherSqlReaderMapper(string connectionString, SqlIconnectionFactory connectionFactory)
        {
        ...
        {
            bool result = false;
            using (var conn = _connectionFactory.GetConnectionString(_connectionString))
            {
