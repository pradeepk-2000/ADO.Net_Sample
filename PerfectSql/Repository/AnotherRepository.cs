...
{
    public class AnotherRepository : AnotherIEmployeeRepository
    {
        private readonly AnotherISqlReaderMapper _mapper;
        public AnotherRepository(SqlIconnectionFactory iconnectionFactory, IConnectionString connectionString, IResultReaderMapperFactory mapper)
        {
            //connfactory not use....;
           _mapper = mapper.GetSqlReaderMapper(connectionString.DataBaseOneConnectionString);
        }
