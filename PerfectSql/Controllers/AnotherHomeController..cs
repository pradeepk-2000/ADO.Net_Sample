...
namespace PerfectSql.Controllers
{
    ...
    [ApiController]
    public class AnotherHomeController : ControllerBase
    {
        private readonly ILogger<HomeController> _logger;
        private readonly AnotherIEmployeeRepository _employeeRepository;
        public AnotherHomeController(ILogger<HomeController> logger, AnotherIEmployeeRepository employeeRepository)
        {
